import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, computed, ref, provide, Suspense, nextTick, mergeProps, Transition, watch, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-BepCIZQ6.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/contact-BHsM_5oI.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-Cf1H_1N7.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/portfolio-m-aPlcNG.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/resume-DDPaygQn.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-BCWiBray.js").then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-DuoLJ4nv.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  landing: () => import("./_nuxt/landing-Bca2aMy4.js").then((m) => m.default || m)
};

...
const _routes = [
  {
    ...
    component: () => import('./about-BepCIZQ6.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./contact-BHsM_5oI.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-Cf1H_1N7.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./portfolio-m-aPlcNG.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./resume-DDPaygQn.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-BCWiBray.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-DuoLJ4nv.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  landing: () => import('./landing-Bca2aMy4.mjs').then((m) => m.default || m)
};
...
const _sfc_main$2 = {
  mounted() {
    (void 0).addEventListener("mousemove", this.handleMouseMove);
  },
  methods: {
    handleMouseMove(event) {
      const mouseX = event.clientX;
      const mouseY = event.clientY;
      const mousePointer = (void 0).querySelector(".mouse-pointer");
      mousePointer.style.transform = `translate(${mouseX}px, ${mouseY}px)`;
    }
  },
  beforeDestroy() {
    (void 0).removeEventListener("mousemove", this.handleMouseMove);
  }
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div${_scopeId}><div class="mouse-pointer"${_scopeId}></div>`);
        _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
        _push2(`</div>`);
      } else {
        return [
          createVNode("div", null, [
            createVNode("div", { class: "mouse-pointer" }),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CI2ijqyj.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, useNuxtApp as c, defineAppConfig as d, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
